...
export default function CookiesPage() {
  return (
    <LegalPage title="Politica de cookies" updated="14 de agosto de 2026">
      ...
      <p style={s.p}>
        SISCO utiliza cookies y tecnologias similares necesarias para iniciar sesion, mantener tu cuenta segura,
      ...
      <p style={s.p}>
        Si activas &quot;Recordar usuario&quot; al iniciar sesion, SISCO guarda unicamente tu correo electronico en el
      ...
      <p style={s.p}>
        Al pagar con Mercado Pago, esa plataforma puede usar sus propias cookies conforme a sus politicas. SISCO no
